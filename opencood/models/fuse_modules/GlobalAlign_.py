...
class GlobalAlign(nn.Module):
    def __init__(self,model_cfg) -> None:
        ...
        in_channel = self.model_cfg['in_channels']
        out_channel = self.model_cfg['in_channels']
    ...
    def forward(self, batch_dict):
        ...
        batch_dict['spatial_features'] = deformed_feature #([1, 256, 180, 180])  Bev features after muli-modal fusion
