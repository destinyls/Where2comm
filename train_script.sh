...
CUDA_VISIBLE_DEVICES=6 python opencood/tools/inference.py --model_dir opencood/logs/no_mae_logs/dair_where2comm_max_multiscale_resnet_2024_09_04_23_11_03  --fusion_method intermediate_with_comm