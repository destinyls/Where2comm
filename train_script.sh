...
CUDA_VISIBLE_DEVICES=7 python opencood/tools/inference.py --model_dir opencood/logs/exp/flowPre_dair_where2comm_max_multiscale_resnet_2024_10_15_06_32_25 --fusion_method intermediate_with_comm
